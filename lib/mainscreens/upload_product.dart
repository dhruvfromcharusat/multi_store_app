...
class _UploadProductScreenState extends State<UploadProductScreen> {
  ...
  Future<void> uploadImages() async {
    if (mainCateroryValue != 'select category' &&
        subCategValue != 'subcategory') {
      if (_formkey.currentState!.validate()) {
        ...
        if (imagesFileList!.isNotEmpty) {
          ...
          MyMessageHandler.showSnackBar(
              _scaffoldkey, 'please select at least one image');
        }
      } else {
    ...
    if (imageUrlList.isNotEmpty) {
      ...
      await productRef.doc(proId).set({
        ...
        setState(() {
          processing = false;
          imagesFileList = [];
          mainCateroryValue = 'select category';
          subCategList = [];
          imageUrlList = [];
        });
  ...
  void uploadProduct() async {
    await uploadImages().whenComplete(() => uplaodData());
  }
  ...
  late String proDesc;
  late String proId;
  String mainCateroryValue = 'select category';
