            ...
            children: [
              AnimatedTextKit(
                animatedTexts: [
                  ...
                  ColorizeAnimatedText('S.S. Retailers',
                      textStyle: const TextStyle(
                          fontSize: 45,
                          fontWeight: FontWeight.bold,
                          fontFamily: 'Acme'),
                ...
                child: DefaultTextStyle(
                  ...
                  child: AnimatedTextKit(
                    animatedTexts: [
                      ...
                      RotateAnimatedText('S.S. Retailers'),
                    ],
                    isRepeatingAnimation: true,
                    repeatForever: true,
                  ),
...
class GoogleFacebookLogine extends StatelessWidget {
  final String label;
  final Function() onPressed;
  final Widget child;
  const GoogleFacebookLogine(
      {Key? key,
      required this.child,
      required this.label,
